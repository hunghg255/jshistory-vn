...
1. **[The Birth of the Language](./part-1-vn.md)** (The Origins of JavaScript), introduces the creation and early development of JavaScript, including the language’s birth background, naming method, initial features and its design philosophy wait. This section also traces its initial evolution at Netscape and other companies, such as Microsoft's JScript.
2. **[Creating a Standard](./part-2-vn.md)** (Creating a Standard) introduces the process from JavaScript to ECMAScript standard. This mainly covers the initiation of JavaScript standardization work, the creation of specifications, relevant contributors, and decision-making methods.
3. **[Failed Reformations](./part-3-vn.md)** (Failed Reformations), which introduces the failed attempts of the ECMAScript committee to modify the language after Eich left, lacking a "benevolent dictator". This mainly involves committee splits, two rounds of investment in ES4, and the origins of Flash and ActionScript in it.
4. **[Carry on the past and open up the future](./part-4-vn.md)** (Modernizing JavaScript), introduces the story behind the two successful standards of ES5 in 2009 and ES6 in 2015, mainly including the goals of ES5 and ES6, An introduction and review of major fundamental changes and important new features.

## Table of contents
* [The birth of language](./part-1-vn.md)
   * [Prehistoric Era](./part-1-vn.md#Prehistoric Era)
   * [Brendan Eich joins Netscape](./part-1-vn.md#brendan-eich-joins Netscape)
   * [Mocha’s Story](./part-1-vn.md#mocha-’s story)
   * [JavaScript 1.0 and 1.1](./part-1-vn.md#javascript-10-and-11)
     * [JavaScript syntax](./part-1-vn.md#javascript-syntax)
     * [Data type and expression](./part-1-vn.md#Data-type-and-expression)
     * [Object](./part-1-vn.md#Object)
     * [Function object](./part-1-vn.md#Function-object)
     * [Built-in library](./part-1-vn.md#Built-in-library)
     * [Execution model](./part-1-vn.md#Execution-model)
     * [Confusing Behavior and Bug](./part-1-vn.md#Confusing-Behavior-and-bug)
       * [Redundant Statement](./part-1-vn.md#Redundant-Statement)
       * [Implicit type conversion and `==` operator](./part-1-vn.md#Implicit-type conversion-and-operator)
       * [32-bit arithmetic](./part-1-vn.md#32-bit-arithmetic)
       * [`this` keyword](./part-1-vn.md#this-keyword)
       * [Arguments object](./part-1-vn.md#arguments-object)
       * [Special processing for numerical attribute keys](./part-1-vn.md#Special-processing-for-numerical-attribute-keys)
       * [Attribute of original value](./part-1-vn.md#Attribute-of-original-value)
       * [HTML comments in JavaScript](./part-1-vn.md#javascript-in-html-comments)
   * [Microsoft JScript](./part-1-vn.md#Microsoft-jscript22)
   * [From Mocha to SpiderMonkey](./part-1-vn.md#from-mocha-to-spidermonkey)
* [Interlude: Feng Ping was murdered](./part-1-vn.md#Interlude:-Feng-Ping-was-murdered)
* [Creation Standard](./part-2-vn.md)
   * [Find venue](./part-2-vn.md#Find-venue)
   * [First TC39 meeting](./part-2-vn.md#First-tc39-meeting)
   * [Writing specifications](./part-2-vn.md#Writing-specifications)
   * [Naming Standard](./part-2-vn.md#Naming Standard)
   * [ISO Fast Track](./part-2-vn.md#iso-Fast Track)
   * [Definition ECMAScript 3](./part-2-vn.md#define-ecmascript-3)
* [Interlude: JavaScript does not require Java](./part-2-vn.md#Interlude javascript-java is not required)
   * [Preacher](./part-2-vn.md#Preacher)
...
* [Reform failed](./part-3-vn.md)
   ...
   * [Flash and ActionScript](./part-3-vn.md#flash-and-actionscript)
   * [Second attempt at ES4](./part-3-vn.md#Second attempt at -es4-)
     * [Reset TC39-TG1](./part-3-vn.md#reset-tc39-tg1)
     * [Redesign ES4](./part-3-vn.md#Redesign-es4)
     * [Resistance](./part-3-vn.md#Resistance)
     * [Seeking Harmony](./part-3-vn.md#Seeking Harmony)
* [Interlude: Take JavaScript Seriously](./part-3-vn.md#Interlude Take JavaScript Seriously-javascript)
   ...
   * [CommonJS and Node.js](./part-3-vn.md#commonjs-and-nodejs)
...
* [Carry on the past and open up the future](./part-4-vn.md)
   * [Develop ES3.1/ES5](./part-4-vn.md#Develop-es31es5)
     * [ES5 Technical Design](./part-4-vn.md#es5-Technical Design)
       ...
       * [Other ES5 features](./part-4-vn.md#other-es5-features)
     * [Implementation and Testing](./part-4-vn.md#Implementation and Testing 86)
   * [From Harmony to ECMAScript 2015](./part-4-vn.md#from-harmony-to-ecmascript-2015)
     * [Start investing in Harmony](./part-4-vn.md#Start investing in Harmony)
       ...
       * [One JavaScript](./part-4-vn.md#one-javascript)
     ...
     * [ES2015 Language Features](./part-4-vn.md#es2015-Language Features)
       ...
       * [Class](./part-4-vn.md#Class)
       * [Module](./part-4-vn.md#module)
     ...
     * [Harmony translator](./part-4-vn.md#harmony-translator)
     * [Complete ECMAScript 2015](./part-4-vn.md#Complete-ecmascript-2015)
* [Summary](./part-4-vn.md#Summary)
* [Acknowledgments](./part-4-vn.md#Acknowledgements)
